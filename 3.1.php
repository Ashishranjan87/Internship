            ...
            <div id="content">
                ...
                <form action="3.1_script.php" method="post">
                    ...
                    <div class="container">
                        ...
                        <div style="float: right; width: 45%"><input type="number" id="average" name="average"></div>
                    </div>
                    <div class="container">
                    ...
                    <div class="container">
                        ...
                        <div style="float: right; width: 45%"><input type="number" id="percentageofdepartments" name="percentageofdepartments"></div>    
                    </div>
                    <div class="container">
