 ...
 <!-- Page Content Holder -->
            <div id="content">
                ...
                <form>
                    ...
                    <div class="container">
                        <div style="float: left; width: 45%">Extension activities are carried out in the neighborhood community, sensitizing students to social issues, for their holistic development, and impact thereof during the last five years</div>
                    ...
                    <div class="container">
                        <div style="float: left; width: 45%">Number of awards and recognitions received for extension activities from government/ government recognised bodies during the last five years</div>
                        <div style="float: right; width: 50%"> <input type="number" name="numberofawards"></div>
                    </div>    
                        <div class="container">
                        <div style="float: left; width: 45%">Total number of awards and recognition received for extension activities from government/givernment recognized bodies year-wise during the last five years.</div>
                        <div style="float: right; width: 45%">
                            ...
                            <tr>
                                <td><input type="number" id="num_1"></td>
                                <td><input type="number" id="num_2"></td>
                                <td><input type="number" id="num_3"></td>
                                <td><input type="number" id="num_4"></td>
                                <td><input type="number" id="num_5"></td>
                            </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        ...
                        <div style="float: left; width: 45%"><input type="number" name="studentsparticicpating"></div>
                    </div>
                    <div class="container">
